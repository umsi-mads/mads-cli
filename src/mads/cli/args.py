...
def register_module_as_subcommand(mod, subparser: argparse._SubParsersAction):
...
for cmdname in commands.__all__:
    mod = getattr(commands, cmdname)
    register_module_as_subcommand(mod, subcommands)
